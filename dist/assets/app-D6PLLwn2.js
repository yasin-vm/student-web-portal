(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const c of a)if(c.type==="childList")for(const u of c.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&o(u)}).observe(document,{childList:!0,subtree:!0});function e(a){const c={};return a.integrity&&(c.integrity=a.integrity),a.referrerPolicy&&(c.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?c.credentials="include":a.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function o(a){if(a.ep)return;a.ep=!0;const c=e(a);fetch(a.href,c)}})();const $="student_portal_db_v4",H=["ABHIRAM ANIL P.A","ADWAITH K","AKASH P S","AMEGHA S","ANANDU M","ANANYA MOHAN N","ANJANA K","ANJANA RAJ R","ANJITHA V","ATHUL K SANDEEP","ATHUL RAJ","FATHIMA RIZA ERSHAD","FATHIMA SABA M","FATHIMATH SAHDIYA C","FATHIMATH SHIFANA T V","FATHIMATHU SUHADHA K V","FATHIMA ZIYA","FIDHA FATHIMA T","GOPIKA T K","HREDYA M","HRIDUSH PRAKASH","JEROME JIMMY","KENZAH RAFFY K","KRISHNA SAJEEVAN","MARJANA K P","MISHAL MAJEED K V","MOHAMMED AZEEM SAMBRATH","MUHAMMAD NIHAL","MUHAMMED FINAS NOUFAL A P","MUHAMMED MAZIN K P","MUHAMMED THAHA K T","MUHAMMED ZAID O V","N LIYA RAZAK","RAYA FATHIMA","RISNA RAFEEQ B M","RIYA P P","RIZA MEHAK","ROSHNI K","SABAH SHAMEER","SANKEERTHANA P","SAYANAND M P","SAYAND A N","SAYYIDHA SHERIN K","SHIJAS SHABEER K P","SHIVADHA R","SHYAMJITH M","SOUMMYAKEERTHI K S","SWETHA V","YADHU SAGAR N","YADU DEV M","YASHIKA PRASANTH","YASIN V M","ZAID IBNU ABDUL GAFOOR","MARIYAM P","AKASH P M","AKSHARA K M","ANJANA K","ANUSREE PRAKASHAN","ASRITHA S NATH"],E=H.map((t,n)=>{const e=String(n+1).padStart(2,"0"),o=e==="52";return{id:n+1,name:t,rollNumber:e,age:20,bloodGroup:"",cgpa:"",internalMarks:"",extracurricular:"",course:"B.Tech Computer Science",semester:"S7",email:"",phone:"",profileImage:`https://ui-avatars.com/api/?name=${encodeURIComponent(t)}&background=4f46e5&color=fff`,websiteSubmitted:o,websiteTitle:o?"Yasin V M | Student Profile":`${t}'s Web Project`,websiteDescription:o?"HTML, CSS, and JavaScript student profile assignment.":"Student web development assignment.",submissionDate:o?"2026-09-08":null,websitePath:`submissions/${e}/index.html`}}),f={getAll(){const t=localStorage.getItem($);if(t===null)return this.save(E),E;try{return JSON.parse(t)}catch(n){return console.error("Failed to parse student data, resetting to empty list",n),this.save(E),E}},save(t){localStorage.setItem($,JSON.stringify(t))},getByRoll(t){if(!t)return null;const n=String(t).padStart(2,"0");return this.getAll().find(o=>String(o.rollNumber).padStart(2,"0")===n)||null},getSubmitted(){return this.getAll().filter(t=>t.websiteSubmitted===!0)},getStats(){const t=this.getAll(),n=t.length,e=t.filter(c=>c.websiteSubmitted===!0).length,o=n-e,a=n>0?Math.round(e/n*100):0;return{total:n,submitted:e,pending:o,percentage:a}},addStudent(t){const n=this.getAll(),e=String(t.rollNumber).padStart(2,"0");if(n.some(c=>String(c.rollNumber).padStart(2,"0")===e))throw new Error(`Roll number ${e} already exists! Please use a unique roll number.`);const o=t.websiteSubmitted===!0,a={id:Date.now(),name:t.name,rollNumber:e,age:parseInt(t.age)||20,bloodGroup:t.bloodGroup||"O+",cgpa:t.cgpa||"",internalMarks:t.internalMarks||"",extracurricular:t.extracurricular||"",course:t.course,semester:t.semester,email:t.email,phone:t.phone,profileImage:t.profileImage||`https://ui-avatars.com/api/?name=${encodeURIComponent(t.name)}&background=4f46e5&color=fff`,websiteSubmitted:o,websiteTitle:o?t.websiteTitle||`${t.name}'s Web Project`:null,websiteDescription:o?t.websiteDescription||"Personal student project website.":null,submissionDate:o?t.submissionDate||new Date().toISOString().split("T")[0]:null,websitePath:o?t.websitePath||`submissions/${e}/index.html`:null};return n.push(a),this.save(n),a},updateStudent(t,n){const e=this.getAll(),o=String(t).padStart(2,"0"),a=e.findIndex(c=>String(c.rollNumber).padStart(2,"0")===o);if(a===-1)throw new Error(`Student with Roll No ${o} not found.`);return n.websiteSubmitted!==void 0&&(n.websiteSubmitted?(n.websitePath=n.websitePath||`submissions/${o}/index.html`,n.websiteTitle=n.websiteTitle||`${e[a].name}'s Web Project`,n.submissionDate=n.submissionDate||new Date().toISOString().split("T")[0]):(n.websitePath=null,n.websiteTitle=null,n.websiteDescription=null,n.submissionDate=null)),e[a]={...e[a],...n},this.save(e),e[a]},deleteStudent(t){let n=this.getAll();const e=String(t).padStart(2,"0");n=n.filter(o=>String(o.rollNumber).padStart(2,"0")!==e),this.save(n)},clearAll(){this.save([])},resetToDefaults(){return this.save(E),E}};function S(t,n="success"){let e=document.querySelector(".toast-container");e||(e=document.createElement("div"),e.className="toast-container",document.body.appendChild(e));const o=document.createElement("div");o.className=`toast toast-${n}`,o.innerHTML=`
  ...
  `,e.appendChild(o),setTimeout(()=>{o.style.opacity="0",o.style.transform="translateX(100%)",setTimeout(()=>o.remove(),300)},4e3)}function T(){const t=document.querySelector(".mobile-menu-btn"),n=document.querySelector(".nav-links");t&&n&&t.addEventListener("click",()=>{n.classList.toggle("mobile-open")});const e=window.location.pathname.split("/").pop()||"index.html";document.querySelectorAll(".nav-link").forEach(o=>{const a=o.getAttribute("href");(a===e||e===""&&a==="index.html")&&o.classList.add("active")})}function L(t){const n=f.getByRoll(t);if(!n||!n.websiteSubmitted||!n.websitePath){S("No website submitted for this student.","error");return}window.open(n.websitePath,"_blank")}window.openStudentWebsite=L;function x(){const t=f.getStats(),n=document.getElementById("stat-total"),e=document.getElementById("stat-submitted"),o=document.getElementById("stat-pending"),a=document.getElementById("stat-rate");n&&(n.textContent=t.total),e&&(e.textContent=t.submitted),o&&(o.textContent=t.pending),a&&(a.textContent=`${t.percentage}%`);const c=document.getElementById("featured-students-grid");if(c){const b=f.getAll();if(b.length===0)c.innerHTML=`
      ...
      `;else{const g=b.slice(0,4);c.innerHTML=g.map(i=>`
        <div class="student-card">
          <div class="card-header-banner">
            <div class="card-avatar-wrap">
              <img src="${i.profileImage}" alt="${i.name}" class="card-avatar" onerror="this.src='https://ui-avatars.com/api/?name=${encodeURIComponent(i.name)}&background=4f46e5&color=fff'">
            </div>
          ...
          <div class="card-body">
            <h3 class="student-name">${i.name}</h3>
            <span class="roll-tag">Roll No: ${i.rollNumber}</span>
            <div class="student-meta">
              <div class="meta-item"><span>🎓</span> <span>${i.course} (${i.semester})</span></div>
              <div class="meta-item"><span>📧</span> <span>${i.email}</span></div>
            </div>
      ...
      `;else{const g=b.slice(0,6);u.innerHTML=g.map(i=>`
        <div class="showcase-card">
          <div class="showcase-card-header">
            <img src="${i.profileImage}" alt="${i.name}" class="showcase-avatar" onerror="this.src='https://ui-avatars.com/api/?name=${encodeURIComponent(i.name)}&background=4f46e5&color=fff'">
            <div>
              <h4 class="showcase-student-name">${i.name}</h4>
              <span class="roll-tag">Roll No: ${i.rollNumber}</span>
            </div>
          </div>
          <div class="showcase-card-body">
            <h3 class="showcase-title">${i.websiteTitle||"Student Web Project"}</h3>
            <p class="showcase-desc">${i.websiteDescription||"Interactive web application submission."}</p>
          </div>
          <div class="showcase-card-footer">
            <span class="showcase-date">📅 ${i.submissionDate||"2026-08-10"}</span>
            <a href="${i.websitePath}" target="_blank" rel="noopener" class="btn btn-primary btn-sm">
              🚀 View Website
            </a>
          </div>
        </div>
      `).join("")}}}function P(){const t=document.getElementById("dir-search"),n=document.getElementById("dir-course"),e=document.getElementById("dir-semester"),o=document.getElementById("dir-status"),a=document.getElementById("dir-blood"),c=document.getElementById("dir-sort"),u=document.getElementById("directory-table-body"),b=document.getElementById("directory-empty-state"),g=document.getElementById("directory-count");let i=1;const h=12;function y(){let s=f.getAll();const m=t?t.value.trim().toLowerCase():"",r=n?n.value:"",p=e?e.value:"",v=o?o.value:"",I=a?a.value:"",A=c?c.value:"roll-asc";if(m&&(s=s.filter(d=>d.name.toLowerCase().includes(m)||String(d.rollNumber).toLowerCase().includes(m))),r&&(s=s.filter(d=>d.course.toLowerCase().includes(r.toLowerCase())||r===d.course)),p&&(s=s.filter(d=>d.semester===p)),v&&(v==="submitted"&&(s=s.filter(d=>d.websiteSubmitted===!0)),v==="null"&&(s=s.filter(d=>d.websiteSubmitted===!1))),I&&(s=s.filter(d=>d.bloodGroup===I)),s.sort((d,B)=>A==="roll-asc"?parseInt(d.rollNumber)-parseInt(B.rollNumber):A==="roll-desc"?parseInt(B.rollNumber)-parseInt(d.rollNumber):A==="name-asc"?d.name.localeCompare(B.name):A==="name-desc"?B.name.localeCompare(d.name):0),g&&(g.textContent=`Showing ${s.length} students`),s.length===0){u&&(u.innerHTML=""),b&&(b.style.display="block");return}b&&(b.style.display="none");const w=Math.ceil(s.length/h);i>w&&(i=1);const N=(i-1)*h,M=s.slice(N,N+h);u&&(u.innerHTML=M.map(d=>`
        <tr>
          <td>
      ...
      `).join("")),l(w)}function l(s){const m=document.getElementById("directory-pagination");if(!m)return;if(s<=1){m.innerHTML="";return}let r="";for(let p=1;p<=s;p++)r+=`<button class="page-btn ${p===i?"active":""}" data-page="${p}">${p}</button>`;m.innerHTML=`
      <div class="pagination-wrap">
        <span style="font-size:0.9rem; color: var(--text-muted);">Page ${i} of ${s}</span>
        <div class="page-numbers">${r}</div>
      </div>
    `,m.querySelectorAll(".page-btn").forEach(p=>{p.addEventListener("click",v=>{i=parseInt(v.target.getAttribute("data-page")),y()})})}[t,n,e,o,a,c].forEach(s=>{s&&s.addEventListener("change",()=>{i=1,y()}),s&&s.tagName==="INPUT"&&s.addEventListener("input",()=>{i=1,y()})}),y()}function R(){const n=new URLSearchParams(window.location.search).get("roll")||"",e=f.getByRoll(n);if(!e){const N=document.getElementById("profile-content");N&&(N.innerHTML=`
      ...
      `);return}const o=document.getElementById("prof-avatar"),a=document.getElementById("prof-name"),c=document.getElementById("prof-roll"),u=document.getElementById("prof-course"),b=document.getElementById("prof-sem"),g=document.getElementById("prof-email"),i=document.getElementById("prof-phone"),h=document.getElementById("prof-age"),y=document.getElementById("prof-blood"),l=document.getElementById("prof-cgpa"),s=document.getElementById("prof-internal-marks"),m=document.getElementById("prof-extracurricular"),r=document.getElementById("prof-college"),p=document.getElementById("prof-bio"),v=document.getElementById("prof-project-box");o&&(o.src=e.profileImage,o.onerror=()=>o.src=`https://ui-avatars.com/api/?name=${encodeURIComponent(e.name)}&background=4f46e5&color=fff`),a&&(a.textContent=e.name),c&&(c.textContent=`Roll No: ${e.rollNumber}`);const I=document.getElementById("prof-roll-val");I&&(I.textContent=`#${e.rollNumber}`),u&&(u.textContent=e.course);const A=document.getElementById("prof-course-val");A&&(A.textContent=e.course),b&&(b.textContent=e.semester);const w=document.getElementById("prof-sem-val");w&&(w.textContent=e.semester),g&&(g.textContent=e.email),i&&(i.textContent=e.phone),h&&(h.textContent=`${e.age} Years`),y&&(y.textContent=e.bloodGroup),l&&(l.textContent=e.cgpa||"Not provided"),s&&(s.textContent=e.internalMarks||"Not provided"),m&&(m.textContent=e.extracurricular||"Not provided"),r&&(r.textContent="Department of Computer Science & Engineering"),p&&(p.textContent=`${e.name} is a student pursuing ${e.course} currently in semester ${e.semester}.`),v&&(e.websiteSubmitted&&e.websitePath?v.innerHTML=`
      ...
      `)}function C(){const t=document.getElementById("admin-table-body"),n=document.getElementById("admin-search"),e=document.getElementById("admin-status-filter"),o=document.getElementById("modal-add-student"),a=document.getElementById("modal-edit-student");function c(){const l=f.getStats(),s=document.getElementById("adm-stat-total"),m=document.getElementById("adm-stat-sub"),r=document.getElementById("adm-stat-pend"),p=document.getElementById("adm-stat-rate");s&&(s.textContent=l.total),m&&(m.textContent=l.submitted),r&&(r.textContent=l.pending),p&&(p.textContent=`${l.percentage}%`)}function u(){let l=f.getAll();const s=n?n.value.trim().toLowerCase():"",m=e?e.value:"";s&&(l=l.filter(r=>r.name.toLowerCase().includes(s)||String(r.rollNumber).toLowerCase().includes(s))),m&&(m==="submitted"&&(l=l.filter(r=>r.websiteSubmitted===!0)),m==="null"&&(l=l.filter(r=>r.websiteSubmitted===!1))),t&&(l.length===0?t.innerHTML=`
          <tr>
        ...
        `:t.innerHTML=l.map(r=>`
          <tr>
            <td>
              <div class="table-student-info">
                <img src="${r.profileImage}" alt="${r.name}" class="table-avatar" onerror="this.src='https://ui-avatars.com/api/?name=${encodeURIComponent(r.name)}&background=4f46e5&color=fff'">
                <div>
                  <div class="table-student-name">${r.name}</div>
                  <div class="table-student-email">${r.email}</div>
                </div>
              </div>
            </td>
            <td><span class="roll-tag">#${r.rollNumber}</span></td>
            <td>${r.course}</td>
            <td>${r.semester}</td>
            <td>
              ${r.websiteSubmitted?`
            ...
            <td>
              <div class="action-btns-group">
                ...
                `}
                <button onclick="openEditModal('${r.rollNumber}')" class="btn btn-secondary btn-sm">Edit</button>
                <button onclick="deleteStudent('${r.rollNumber}')" class="btn btn-danger btn-sm">Delete</button>
              </div>
            </td>
          </tr>
        `).join("")),c()}window.deleteStudent=l=>{confirm(`Are you sure you want to delete student Roll No #${l}?`)&&(f.deleteStudent(l),S(`Student #${l} deleted.`),u())},window.openEditModal=l=>{const s=f.getByRoll(l);if(!s)return;document.getElementById("edit-roll-hidden").value=s.rollNumber,document.getElementById("edit-roll-display").value=`#${s.rollNumber}`,document.getElementById("edit-name").value=s.name,document.getElementById("edit-course").value=s.course,document.getElementById("edit-sem").value=s.semester,document.getElementById("edit-email").value=s.email,document.getElementById("edit-phone").value=s.phone;const m=document.getElementById("edit-has-website"),r=document.getElementById("edit-website-fields");m.checked=s.websiteSubmitted===!0,r.style.display=m.checked?"grid":"none",document.getElementById("edit-web-title").value=s.websiteTitle||"",document.getElementById("edit-web-desc").value=s.websiteDescription||"",a.classList.add("active")};const b=document.getElementById("btn-open-add");b&&b.addEventListener("click",()=>{document.getElementById("form-add-student").reset(),document.getElementById("add-website-fields").style.display="none",o.classList.add("active")});const g=document.getElementById("add-has-website");g&&g.addEventListener("change",l=>{document.getElementById("add-website-fields").style.display=l.target.checked?"grid":"none"});const i=document.getElementById("edit-has-website");i&&i.addEventListener("change",l=>{document.getElementById("edit-website-fields").style.display=l.target.checked?"grid":"none"}),document.querySelectorAll(".modal-close-btn, .modal-cancel-btn").forEach(l=>{l.addEventListener("click",()=>{document.querySelectorAll(".modal-backdrop").forEach(s=>s.classList.remove("active"))})});const h=document.getElementById("form-add-student");h&&h.addEventListener("submit",l=>{l.preventDefault();try{const s=document.getElementById("add-roll").value.trim(),m=document.getElementById("add-has-website").checked,r={name:document.getElementById("add-name").value.trim(),rollNumber:s,course:document.getElementById("add-course").value,semester:document.getElementById("add-sem").value,age:parseInt(document.getElementById("add-age").value)||20,bloodGroup:document.getElementById("add-blood").value.trim()||"O+",email:document.getElementById("add-email").value.trim(),phone:document.getElementById("add-phone").value.trim(),websiteSubmitted:m,websiteTitle:document.getElementById("add-web-title").value.trim(),websiteDescription:document.getElementById("add-web-desc").value.trim()};f.addStudent(r),S(`Student #${r.rollNumber} added successfully!`),o.classList.remove("active"),h.reset(),u()}catch(s){S(s.message,"error")}});const y=document.getElementById("form-edit-student");y&&y.addEventListener("submit",l=>{l.preventDefault();try{const s=document.getElementById("edit-roll-hidden").value,m=document.getElementById("edit-has-website").checked;f.updateStudent(s,{name:document.getElementById("edit-name").value.trim(),course:document.getElementById("edit-course").value,semester:document.getElementById("edit-sem").value,email:document.getElementById("edit-email").value.trim(),phone:document.getElementById("edit-phone").value.trim(),websiteSubmitted:m,websiteTitle:document.getElementById("edit-web-title").value.trim(),websiteDescription:document.getElementById("edit-web-desc").value.trim()}),S(`Student #${s} updated successfully.`),a.classList.remove("active"),u()}catch(s){S(s.message,"error")}}),n&&n.addEventListener("input",u),e&&e.addEventListener("change",u),u()}document.addEventListener("DOMContentLoaded",()=>{localStorage.removeItem("student_portal_db_v1"),localStorage.removeItem("student_portal_db_v2"),localStorage.removeItem("student_portal_db_v3"),T();const t=window.location.pathname;t.endsWith("index.html")||t==="/"||t.endsWith("/")?x():t.endsWith("students.html")?P():t.endsWith("profile.html")?R():t.endsWith("admin.html")&&C()});
